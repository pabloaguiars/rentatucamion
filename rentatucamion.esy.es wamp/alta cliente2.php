...
<html>
	...
	<body bgcolor = "Gray" link="sky blue" vlink="sky blue" alink="#fff">
		...
		<?php
				...
				else 
				{
					while($reg = mysqli_fetch_array($registros))
					{
						...
						if(in_array($correo,$reg))
						{
							...
							echo "</center>";
							echo "<hr>";
							echo "<font face = 'sans-serif' color = '#808080'> Regresar <a href = '/rentatucamion.esy.es wamp/index.html'> Clic aqui </a>  </font>";
							exit(0);
						}
					}
				}
			...
			echo "</center>";
			echo "<hr>";
			echo "<font face = 'sans-serif' color = '#fff'> Regresar <a href = '/rentatucamion.esy.es wamp/index.html'> Clic aqui </a>  </font>";
		?>
	</body>
</html>